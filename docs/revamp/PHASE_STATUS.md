...
| Phase 4: UX Rebuild | In Progress | `UX_REBUILD_LOG.md`, `evidence/PHASE4_UX_SLICE_*` | Workspace revamp shell plus queue-first inbox triage slice landed behind flags; legacy default preserved. |
